...
public:
  explicit Pentropy5(const ActionOptions&);
  ~Pentropy5();
// active methods:
...
PLUMED_REGISTER_ACTION(Pentropy5,"PENTROPY5")

void Pentropy5::registerKeywords( Keywords& keys ){
...
Pentropy5::Pentropy5(const ActionOptions&ao):
...
double Pentropy5::pairing(double distance,double&dfunc)const{
